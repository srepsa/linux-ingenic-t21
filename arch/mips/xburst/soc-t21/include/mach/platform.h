...
#define SSI1_PORTC							\
	{ .name = "ssi1-pc",	       .port = GPIO_PORT_B, .func = GPIO_FUNC_1, .pins = (0xf << 8 | 0x3 << 13), }
...
#define GMAC_INTERNAL_PHY_PORTB							\
	{ .name = "gmac_pb",	.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins = ((1<<7) | (1<<15))}
#define GMAC_INTERNAL_PHY_PORTB_NO_ACTLED							\
	{ .name = "gmac_pb",	.port = GPIO_PORT_B, .func = GPIO_FUNC_2, .pins = (1<<6)}
